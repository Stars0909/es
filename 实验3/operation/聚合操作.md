...
## 一、实验目的：熟练使用Elasticsearch 聚合查询语句     

## 二、实验内容：Elasticsearch 聚合操作练习
...
POST /ecommerce/_search
{
  "size": 0,
  "aggs": {
    "top_customers_by_average_order_value": {
      "terms": {
        "field": "customer_id",
        "size": 3,
        "order": {
...
POST /ecommerce/_search
{
  "size": 0,
  "aggs": {
    "average_order_value_per_quarter": {
      "date_histogram": {
        "field": "order_date",
