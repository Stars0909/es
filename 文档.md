...
```
![修改索引——为user_information索引添加age字段.png](img_3.png)
...
GET /_cat/indices?v  
```
![查看所有索引.png](img_4.png)

删除order_records索引
```
DELETE /order_records
```
![删除order_records索引.png](img_5.png)
